...
/// 自定义视频播放器皮肤，修改自chewie的MaterialControls皮肤
class CustomVideoPlayerSkin extends StatefulWidget {
  ...
  State<StatefulWidget> createState() {
    return _CustomVideoPlayerSkinState();
  }
}

class _CustomVideoPlayerSkinState extends State<CustomVideoPlayerSkin>
              ...
              if (_displayBufferingIndicator)
                Center(
                  child: CircularProgressIndicator(
                      color: Colors.white, strokeWidth: 4.w),
                )
              else
                _buildHitArea(),
    ...
    return Expanded(
        child: ProgressBar(
            ...
            onChange: (value) {
              ...
              controller.seekTo(Duration(milliseconds: targetPosition));
            }));
  }
}
